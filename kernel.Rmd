...
Code:
```{r}
customer_data=read.csv("C:/Users/admin/Desktop/master/FID_Datos/proyecto/EmploymentSegmentation/data/Mall_Customers.csv")
str(customer_data)
names(customer_data)
```
Output Screenshot:
...
Have you Checked DataFlair’s Trending Project on Data Science? Must Check – Sentiment Analysis using R
